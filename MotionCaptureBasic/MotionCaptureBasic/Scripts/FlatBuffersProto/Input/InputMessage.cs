...
public struct InputMessage : IFlatbufferObject
{
  ...
  public Input.MessageType Type { get { int o = __p.__offset(6); return o != 0 ? (Input.MessageType)__p.bb.GetShort(o + __p.bb_pos) : Input.MessageType.None; } }
  ...
  public static Offset<Input.InputMessage> CreateInputMessage(FlatBufferBuilder builder,
      StringOffset versionOffset = default(StringOffset),
      Input.MessageType type = Input.MessageType.None,
  ...
  public static void AddType(FlatBufferBuilder builder, Input.MessageType type) { builder.AddShort(1, (short)type, 0); }
  ...
  public static Offset<Input.InputMessage> EndInputMessage(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Input.InputMessage>(o);
  }
  public static void FinishInputMessageBuffer(FlatBufferBuilder builder, Offset<Input.InputMessage> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedInputMessageBuffer(FlatBufferBuilder builder, Offset<Input.InputMessage> offset) { builder.FinishSizePrefixed(offset.Value); }
}
