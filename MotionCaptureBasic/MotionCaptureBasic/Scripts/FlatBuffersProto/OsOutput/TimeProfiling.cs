...
public struct TimeProfiling : IFlatbufferObject
{
  ...
  public static Offset<OsOutput.TimeProfiling> CreateTimeProfiling(FlatBufferBuilder builder,
  ...
  public static Offset<OsOutput.TimeProfiling> EndTimeProfiling(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OsOutput.TimeProfiling>(o);
  }
}
