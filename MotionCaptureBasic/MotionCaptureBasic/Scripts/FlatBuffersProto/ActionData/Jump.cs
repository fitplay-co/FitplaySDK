...
public struct Jump : IFlatbufferObject
{
  ...
  public float OnTheGround { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  ...
  public static void AddOnTheGround(FlatBufferBuilder builder, float onTheGround) { builder.AddFloat(0, onTheGround, 0.0f); }
