...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
        ...
        private int lastLOD;
        private BaseAvatarIKInfo AvatarInfo = new BaseAvatarIKInfo();
                ...
                if (locomotion.weight > 0f)
                {
                    switch (locomotion.mode)
                    {
                        case Locomotion.Mode.Procedural:
                            ...
                            AvatarInfo.SetInfo(rootBone, spine, leftLeg, rightLeg, leftArm, rightArm, supportLegIndex, leftFootPosition, rightFootPosition, 
	                            leftFootRotation, rightFootRotation, leftFootOffset, rightFootOffset, leftHeelOffset, rightHeelOffset, scale, deltaTime,rootVelocity);
                            locomotion.Solve_Procedural_New(AvatarInfo);
                            ...
                            AvatarInfo.GetInfo(out leftFootPosition, out rightFootPosition, out leftFootRotation, out rightFootRotation, out leftFootOffset, out rightFootOffset, out leftHeelOffset, out rightHeelOffset);
