...
{
    internal class URP_Anisotropic : BaseShaderGUI
    {
        // Properties
        private URP_AnisotropicGUI.AnisotropicProperties litProperties;

        // collect properties from the material properties
        public override void FindProperties(MaterialProperty[] properties)
        {
            base.FindProperties(properties);
            litProperties = new URP_AnisotropicGUI.AnisotropicProperties(properties);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            URP_AnisotropicGUI.Inputs(litProperties, materialEditor, material);
