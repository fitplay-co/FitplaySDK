...
{
    public static class URP_AnisotropicGUI
    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent tangentText = new GUIContent("Tangent Map",
               "Tangent Map, Like Normal map, it is the right direction of a surface point in tangent space");

            public static GUIContent anisotropicText = new GUIContent("Anisotropic Map",
               "Anisotropic Map, indicate the anisotropic intensity of the surface ");

            public static readonly string[] metallicSmoothnessChannelNames = { "Metallic Alpha", "Albedo Alpha" };
            public static readonly string[] specularSmoothnessChannelNames = { "Specular Alpha", "Albedo Alpha" };
        }

        public struct AnisotropicProperties
        {
            ...
            public MaterialProperty tangentMap;
            public MaterialProperty anisotropicMap;
            public MaterialProperty anisotropicStrength;

            // Advanced Props
            public MaterialProperty highlights;
            public MaterialProperty reflections;

            public AnisotropicProperties(MaterialProperty[] properties)
            {
                // Surface Option Props
                ...
                anisotropicMap = BaseShaderGUI.FindProperty("_AnisotropyMap", properties, false);
                anisotropicStrength = BaseShaderGUI.FindProperty("_Anisotropy", properties, false);
            }
        }

        public static void Inputs(AnisotropicProperties properties, MaterialEditor materialEditor, Material material)
        {
            DoMetallicSpecularArea(properties, materialEditor, material);
            BaseShaderGUI.DrawNormalArea(materialEditor, properties.bumpMapProp, properties.bumpScaleProp);

            if (properties.tangentMap != null)
            {
                materialEditor.TexturePropertySingleLine(Styles.tangentText, properties.tangentMap,null);
            }

            if (properties.anisotropicMap != null)
            {
                materialEditor.TexturePropertySingleLine(Styles.anisotropicText, properties.anisotropicMap, 
                                                         properties.anisotropicStrength);
            }
        ...
        public static void DoMetallicSpecularArea(AnisotropicProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            if (properties.workflowMode == null ||(WorkflowMode)properties.workflowMode.floatValue == WorkflowMode.Metallic)
            {
                materialEditor.ColorProperty(properties.specColor, "SpecularTint");
            }
        }

        public static void DoSmoothness(AnisotropicProperties properties, Material material, string[] smoothnessChannelNames)
        {
