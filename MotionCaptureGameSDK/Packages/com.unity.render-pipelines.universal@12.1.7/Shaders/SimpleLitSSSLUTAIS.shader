...
Shader "Universal Render Pipeline/Simple Lit SSSLUTAIS"
{
    ...
    Properties
    {
        ...
        /////////////////////////////////////////////
            ...
            _Shadow0("Shadow0", Range(-2, 2)) = 0
            _Shadow1("Shadow1", Range(-2, 2)) = 1
                /////////////////////////////////////////////
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/SimpleLitInputSSSLUTAIS.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/SimpleLitForwardPassSSSLUTAIS.hlsl"
            ENDHLSL
        }
