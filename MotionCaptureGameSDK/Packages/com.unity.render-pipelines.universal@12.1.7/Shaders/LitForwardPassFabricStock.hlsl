...
half4 LitPassFragment(Varyings input) : SV_Target
{
...
#ifdef _DBUFFER
    ApplyDecalToSurfaceData(input.positionCS, surfaceData, inputData);//暂无贴画需求
#endif
    ////////////////////////////////////////////////////////////////////
    half4 stockingColor = SAMPLE_TEXTURE2D(_StockingTex, sampler_StockingTex, input.uv) * _StockingTint * _StockingTint.a;
    ...
    float density = max(rim, (denier * (1 - SAMPLE_TEXTURE2D(_DenierTex, sampler_DenierTex, input.uv))));  //lerp参数
    surfaceData.albedo = lerp(surfaceData.albedo, stockingColor, density);
    surfaceData.albedo = surfaceData.albedo * lerp(_Fresnel0, _Fresnel1, 1 - fresnel);
    ////////////////////////////////////////////////////////////////////
