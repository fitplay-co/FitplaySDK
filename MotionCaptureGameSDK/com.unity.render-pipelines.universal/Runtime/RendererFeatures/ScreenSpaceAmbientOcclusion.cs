...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class ScreenSpaceAmbientOcclusionSettings
    {
        ...
        [SerializeField] internal float IntensityVar = 0.0f;
        [SerializeField] internal Texture2D t2dCurve = null;
        // Enums
    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        public AnimationCurve curveHRPHWS = AnimationCurve.Linear(0, 0, 1, 1);
        // Private Fields
        ...
        public override void Create()
        {
            ...
            m_SSAOPass.curveHRPHWS = this.curveHRPHWS;
        }
        public AnimationCurve GetCurve()
        {
            return m_SSAOPass != null ? m_SSAOPass.curveHRPHWS : null;
        }
        public void SetCurve(AnimationCurve varCurve)
        {
            if (m_SSAOPass != null)
                m_SSAOPass.curveHRPHWS = varCurve;
        }
        /// <inheritdoc/>
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            var camera = renderingData.cameraData.camera;
            if (camera.cameraType != CameraType.Game || camera.clearFlags != CameraClearFlags.Skybox)
            {
                return;
            }
            if (!GetMaterial())
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                material.SetTexture("_SSAO_CurveRT",this.m_CurrentSettings.t2dCurve);
                material.SetFloat("_IntensityVar", this.m_CurrentSettings.IntensityVar);
                // Update keywords
