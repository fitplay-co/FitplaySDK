...
#endif
        private IndirectDrawPass m_IndirectDrawPass;
        private IndirectCullPass m_IndirectCullPass;
        private IndirectDrawData m_IndirectDrawData;
...
#pragma warning restore 414
        ...
        public ForwardRenderer(ForwardRendererData data) : base(data)
        {
            ...
            m_HiZMaterial = CoreUtils.CreateEngineMaterial(data.shaders.blitShader);
            ...
            // Do Indirect Draw follow closely Render Opaque Objects(Event 251 and 252)
            m_IndirectDrawPass = new IndirectDrawPass(URPProfileId.IndirectDraw, RenderPassEvent.BeforeRenderingOpaques);
            m_IndirectCullPass = new IndirectCullPass(URPProfileId.IndirectCull, RenderPassEvent.BeforeRendering,
                data.shaders.cullingShader, m_HiZMaterial);
            m_IndirectDrawData = IndirectDrawData.GetInstance();
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            bool requiresIndirectDraw = cameraData.renderType == CameraRenderType.Base &&
                    m_IndirectDrawData.IndirectDrawInfos != null &&
                    m_IndirectDrawData.InstanceTotalCount > 0 &&
                    !cameraData.isSceneViewCamera &&
                    camera.name != "Preview Camera";

            if (requiresIndirectDraw)
            {
                this.m_IndirectCullPass.Setup(ref renderingData);
                EnqueuePass(this.m_IndirectCullPass);
                EnqueuePass(this.m_IndirectDrawPass);
            }
