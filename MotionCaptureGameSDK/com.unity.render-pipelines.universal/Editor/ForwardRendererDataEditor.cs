...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class ForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent CullingShaderLabel = new GUIContent("Culling Compute Shader", "Select a compute shader.");
            public static readonly GUIContent BlitShaderLabel = new GUIContent("HiZ Buffer Shader", "Select a blit shader.");
        }
        ...
        private SerializedProperty blitShader;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(cullingShader, Styles.CullingShaderLabel);
            EditorGUILayout.PropertyField(blitShader, Styles.BlitShaderLabel);
            EditorGUI.indentLevel--;
            EditorGUILayout.Space();
