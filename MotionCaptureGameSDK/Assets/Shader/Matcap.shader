    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                OUTPUT_SH(OUT.normalVS.xyz, OUT.vertexSH);
                return OUT;
            }
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                //half3 bakedGI = SAMPLE_GI(input.lightmapUV, input.vertexSH, perturbedNormalTS);
                half3 bakedGI = SAMPLE_GI(IN.lightmapUV, IN.vertexSH, perturbedNormalTS);
                //half3 attenuatedLightColor = mainLight.color * (mainLight.distanceAttenuation * mainLight.shadowAttenuation);
                //half3 diffuseColor = bakedGI + LightingLambert(attenuatedLightColor, mainLight.direction, perturbedNormalTS);
                //没normalmap，先这样
//#ifdef _NORMALMAP
...
//#endif
                ...
                finalColor *= mainLight.shadowAttenuation+ bakedGI;
                //finalColor *= diffuseColor;
                //finalColor = bakedGI;
                //finalColor = attenuatedLightColor;
