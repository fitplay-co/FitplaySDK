...
Shader "Universal Render Pipeline/EyeKLTH"
{
	Properties
	{
...
//			#pragma multi_compile _ _SHADOWS_SOFT
			...
			UNITY_INSTANCING_BUFFER_START(EyeShaderKLTH_URP)
				UNITY_DEFINE_INSTANCED_PROP(float, _MinimumGlow)
			UNITY_INSTANCING_BUFFER_END(EyeShaderKLTH_URP)
						 ...
						 ) : SV_Target
			{
				...
				float dotResult4_g24 = dot( SafeNormalize(_MainLightPosition.xyz) , temp_cast_8 );
				float temp_output_6_0_g24 = ( dotResult4_g24 - (-1.0 + (_MainLightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) );
				float lerpResult536 = lerp( _PupilSize , ( _PupilSize + ( ( ( ( ( break690.x + break690.y + break690.z ) / 3.0 ) * saturate( temp_output_6_0_g24 ) ) * IrisPupil_MASK585 ) * _PupilAutoDilateFactor ) ) , _PupilAffectedByLight_Amount);
				...
				float _MinimumGlow_Instance = UNITY_ACCESS_INSTANCED_PROP(EyeShaderKLTH_URP,_MinimumGlow);
				float clampResult478 = clamp( ( ( _FalloffAdjuster * dotResult5_g38 ) * PupilMaskArea625 ) , _MinimumGlow_Instance , 1.0 );
				float4 transform3_g40 = mul(GetObjectToWorldMatrix(),float4( 0,-3,1,0.78 ));
				float dotResult6_g40 = dot( float4( WorldNormal , 0.0 ) , transform3_g40 );
				float clampResult7_g40 = clamp( dotResult6_g40 , 0.0 , 1.0 );
				float4 transform2_g40 = mul(GetObjectToWorldMatrix(),float4( 0,1.2,1,0.78 ));
				float dotResult5_g40 = dot( float4( WorldNormal , 0.0 ) , transform2_g40 );
				float clampResult8_g40 = clamp( dotResult5_g40 , 0.0 , 1.0 );
				float temp_output_17_0_g40 = 0.0;
				float3 temp_cast_14 = (pow( ( clampResult7_g40 * clampResult8_g40 ) , temp_output_17_0_g40 )).xxx;
				float temp_output_12_0_g40 = ( temp_output_17_0_g40 * 0.5 );
				float clampResult18_g40 = clamp( temp_output_12_0_g40 , 0.0 , 0.99 );
				float temp_output_2_0_g41 = clampResult18_g40;
				...
				float2 texCoord3_g55 = IN.ase_texcoord8.xy * temp_cast_19 + float2( 0,0 );
				float simplePerlin3D4_g55 = snoise( float3( texCoord3_g55 ,  0.0 ) );
				float2 appendResult6_g55 = (float2(simplePerlin3D4_g55 , simplePerlin3D4_g55));
				float4 appendResult572 = (float4(appendResult6_g55 , 1.0 , 0.0));
...
/*ASEBEGIN
Version=18909
1706.667;0.6666667;1621.333;857;-4971.894;-390.7168;1.3;False;True
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Inherit;False;MicroScatterScale_vec2;36;;55;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;750;-262.8058,2518.117;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;24;0;Create;True;0;0;0;False;0;False;1;0.909;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-276.5095,369.9954;Float;False;Property;_LensPush;LensPush;18;0;Create;True;0;0;0;False;0;False;0.64;0.64;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-828.0912,2277.987;Float;False;Property;_CausticPower;CausticPower;23;0;Create;True;0;0;0;False;0;False;10;6.32;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-753.7518,947.6635;Float;False;Property;_LensGloss;LensGloss;17;0;Create;True;0;0;0;False;0;False;0.98;0.817;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;499;353.9738,-222.3932;Float;False;Property;_Eyeball_microScatter;Eyeball_microScatter;44;0;Create;True;0;0;0;False;0;False;0;1.61;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;868;5242.331,2240.898;Inherit;False;Property;_Final_Illumination_Power;Final_Illumination_Power;40;0;Create;True;0;0;0;False;0;False;1;3.91;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;759;-858.1108,2447.825;Inherit;False;ConstantBiasScale;-1;;56;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);8;0;Create;True;0;0;0;False;0;False;0.08088237,0.07573904,0.04698314,0.591;0.1226415,0.06702682,0.0320102,0.516;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;707;-2990.846,75.49301;Float;False;Property;_LimbalEdge_Adjustment;LimbalEdge_Adjustment;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3461.919,-655.2391;Float;False;Property;_EyeSize;EyeSize;14;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;-3471.69,-774.9874;Float;False;Property;_IrisSize;IrisSize;15;0;Create;True;0;0;0;False;0;False;1;1.04;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;419;-4996.699,-631.905;Float;False;Property;_PushParallaxMask;PushParallaxMask;32;0;Create;True;0;0;0;False;0;False;1;4.23;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;257;-5668.911,-1030.676;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;33;0;Create;True;0;0;0;False;0;False;2.5;3;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-5598.821,-1329.853;Half;False;Property;_PupilSize;PupilSize;26;0;Create;True;0;0;0;False;0;False;70;76.8;0.001;99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;637;1687.879,1711.533;Inherit;False;LocalShadowing;-1;;40;cbbcb7bdaf1755b499ae374337e1f753;0;1;17;FLOAT;0;False;2;FLOAT;16;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;647;2707.268,1444.284;Float;False;Property;_PupilColorEmissivenessA;PupilColor-Emissiveness(A);25;0;Create;True;0;0;0;False;2;Header(Pupil Control);Space(6);False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;126;-706.0718,1582.184;Float;False;Property;_IrisBaseColor;IrisBaseColor;7;0;Create;True;0;0;0;False;0;False;0.4999702,0.5441177,0.4641004,1;0.009433985,0.004718891,0.001127331,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;133;-3418.101,633.1917;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);6;0;Create;True;0;0;0;False;2;Header(Color Customization);Space(6);False;1,1,1,0.853;0.6132076,0.5765694,0.5765694,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;182;-3417.43,823.6976;Float;False;Property;_RingColorAmount;RingColor-Amount;10;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.09558818,0.09558818,0.09558818,0.422;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;636;621.0922,1793.227;Inherit;False;LightDirectionZone_float;0;;38;ce816473eb2cf6d4e96d84f2ab098aa5;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;863;5977.844,1596.019;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;849;6584.882,1333.541;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;Universal Render Pipeline/EyeKLTH;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;0;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=EA3A428FD71D0A43518A5BE74EBBB128E82DF93E